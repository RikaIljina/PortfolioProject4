...
urlpatterns = [
    path('dashboard/<str:username>/add/entry/', views.new_entry, name='new_entry'),
    ...
    path('dashboard/<str:username>/edit/<slug:slug>/delete-file/<str:file_id>/', views.delete_old_file, name='delete_old_file'),
